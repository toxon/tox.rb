...
have_type! 'tox/tox.h', 'TOX_ERR_FILE_CONTROL'
...
have_type! 'tox/toxav.h', 'TOXAV_ERR_ANSWER'
have_type! 'tox/toxav.h', 'TOXAV_ERR_SEND_FRAME'
have_type! 'tox/toxav.h', 'TOXAV_ERR_CALL_CONTROL'

have_type! 'tox/toxav.h', 'TOXAV_CALL_CONTROL'
have_type! 'tox/toxav.h', 'enum TOXAV_FRIEND_CALL_STATE'
...
have_const! 'tox/tox.h', 'TOX_SAVEDATA_TYPE_SECRET_KEY'
...
have_const! 'tox/tox.h', 'TOX_ERR_FILE_CONTROL_OK'
have_const! 'tox/tox.h', 'TOX_ERR_FILE_CONTROL_FRIEND_NOT_FOUND'
have_const! 'tox/tox.h', 'TOX_ERR_FILE_CONTROL_FRIEND_NOT_CONNECTED'
have_const! 'tox/tox.h', 'TOX_ERR_FILE_CONTROL_NOT_FOUND'
have_const! 'tox/tox.h', 'TOX_ERR_FILE_CONTROL_NOT_PAUSED'
have_const! 'tox/tox.h', 'TOX_ERR_FILE_CONTROL_DENIED'
have_const! 'tox/tox.h', 'TOX_ERR_FILE_CONTROL_ALREADY_PAUSED'
have_const! 'tox/tox.h', 'TOX_ERR_FILE_CONTROL_SENDQ'
...
have_const! 'tox/toxav.h', 'TOXAV_ERR_ANSWER_OK'
have_const! 'tox/toxav.h', 'TOXAV_ERR_ANSWER_SYNC'
have_const! 'tox/toxav.h', 'TOXAV_ERR_ANSWER_CODEC_INITIALIZATION'
have_const! 'tox/toxav.h', 'TOXAV_ERR_ANSWER_FRIEND_NOT_FOUND'
have_const! 'tox/toxav.h', 'TOXAV_ERR_ANSWER_FRIEND_NOT_CALLING'
have_const! 'tox/toxav.h', 'TOXAV_ERR_ANSWER_INVALID_BIT_RATE'
have_const! 'tox/toxav.h', 'TOXAV_ERR_SEND_FRAME_OK'
have_const! 'tox/toxav.h', 'TOXAV_ERR_SEND_FRAME_NULL'
have_const! 'tox/toxav.h', 'TOXAV_ERR_SEND_FRAME_FRIEND_NOT_FOUND'
have_const! 'tox/toxav.h', 'TOXAV_ERR_SEND_FRAME_FRIEND_NOT_IN_CALL'
have_const! 'tox/toxav.h', 'TOXAV_ERR_SEND_FRAME_SYNC'
have_const! 'tox/toxav.h', 'TOXAV_ERR_SEND_FRAME_INVALID'
have_const! 'tox/toxav.h', 'TOXAV_ERR_SEND_FRAME_PAYLOAD_TYPE_DISABLED'
have_const! 'tox/toxav.h', 'TOXAV_ERR_SEND_FRAME_RTP_FAILED'
have_const! 'tox/toxav.h', 'TOXAV_ERR_CALL_CONTROL_OK'
have_const! 'tox/toxav.h', 'TOXAV_ERR_CALL_CONTROL_SYNC'
have_const! 'tox/toxav.h', 'TOXAV_ERR_CALL_CONTROL_FRIEND_NOT_FOUND'
have_const! 'tox/toxav.h', 'TOXAV_ERR_CALL_CONTROL_FRIEND_NOT_IN_CALL'
have_const! 'tox/toxav.h', 'TOXAV_ERR_CALL_CONTROL_INVALID_TRANSITION'

have_const! 'tox/toxav.h', 'TOXAV_CALL_CONTROL_RESUME'
have_const! 'tox/toxav.h', 'TOXAV_CALL_CONTROL_PAUSE'
have_const! 'tox/toxav.h', 'TOXAV_CALL_CONTROL_CANCEL'
have_const! 'tox/toxav.h', 'TOXAV_CALL_CONTROL_MUTE_AUDIO'
have_const! 'tox/toxav.h', 'TOXAV_CALL_CONTROL_UNMUTE_AUDIO'
have_const! 'tox/toxav.h', 'TOXAV_CALL_CONTROL_HIDE_VIDEO'
have_const! 'tox/toxav.h', 'TOXAV_CALL_CONTROL_SHOW_VIDEO'
have_const! 'tox/toxav.h', 'TOXAV_FRIEND_CALL_STATE_NONE'
have_const! 'tox/toxav.h', 'TOXAV_FRIEND_CALL_STATE_ERROR'
have_const! 'tox/toxav.h', 'TOXAV_FRIEND_CALL_STATE_FINISHED'
have_const! 'tox/toxav.h', 'TOXAV_FRIEND_CALL_STATE_SENDING_A'
have_const! 'tox/toxav.h', 'TOXAV_FRIEND_CALL_STATE_SENDING_V'
have_const! 'tox/toxav.h', 'TOXAV_FRIEND_CALL_STATE_ACCEPTING_A'
have_const! 'tox/toxav.h', 'TOXAV_FRIEND_CALL_STATE_ACCEPTING_V'
...
have_func! 'tox/tox.h', 'tox_options_get_savedata_type'
have_func! 'tox/tox.h', 'tox_options_set_savedata_type'
have_func! 'tox/tox.h', 'tox_options_get_savedata_data'
have_func! 'tox/tox.h', 'tox_options_set_savedata_data'
have_func! 'tox/tox.h', 'tox_options_get_savedata_length'
have_func! 'tox/tox.h', 'tox_options_set_savedata_length'
...
have_func! 'tox/tox.h', 'tox_callback_friend_connection_status'
...
have_func! 'tox/toxav.h', 'toxav_video_send_frame'
have_func! 'tox/toxav.h', 'toxav_callback_call'
have_func! 'tox/toxav.h', 'toxav_callback_call_state'
have_func! 'tox/toxav.h', 'toxav_callback_audio_receive_frame'
have_func! 'tox/toxav.h', 'toxav_callback_video_receive_frame'
have_func! 'tox/toxav.h', 'toxav_call_control'
