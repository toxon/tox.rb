...
have_func 'tox_options_get_proxy_host',              'tox/tox.h' and
have_func 'tox_options_set_proxy_host',              'tox/tox.h' and
...
have_func 'tox_options_set_end_port',                'tox/tox.h' and
have_func 'tox_options_get_tcp_port',                'tox/tox.h' and
have_func 'tox_options_set_tcp_port',                'tox/tox.h' and
...
have_func 'tox_self_get_udp_port',                   'tox/tox.h' and
have_func 'tox_self_get_tcp_port',                   'tox/tox.h' and
